...
public class MultiplyExpression<T> : ICalculationExpression<T> where T : INumber<T>
{
    private readonly ICalculationExpression<T> _expression1;
    private readonly ICalculationExpression<T> _expression2;

    public MultiplyExpression(ICalculationExpression<T> expression1, ICalculationExpression<T> expression2)
    {
