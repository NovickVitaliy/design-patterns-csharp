...
public class SubstractionExpression<T> : ICalculationExpression<T> where T : INumber<T>
{
    private readonly ICalculationExpression<T> _expression1;
    private readonly ICalculationExpression<T> _expression2;

    public SubstractionExpression(ICalculationExpression<T> expression1, ICalculationExpression<T> expression2)
    {
